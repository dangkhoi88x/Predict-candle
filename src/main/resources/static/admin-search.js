...
(function () {
    ...
    var SOURCES = [
        ...
        { pane: "challenges", label: "Thử thách", rows: "#challenge-table tbody tr", primary: "td:nth-child(1)" },
        { pane: "demo", label: "Sàn demo", rows: "#demo-table tbody tr", primary: "td:nth-child(2)" },
